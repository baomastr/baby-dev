...
?>    <div class="row padding__row between section__article section__content-items">
    ...
    <div class="row responsive-column">
        <ul class="section__content-ul col__50">
            <li class="section__content-li"><span class="section__content-link">Педиатр</span></li>
            <li class="section__content-li"><span class="section__content-link">Логопед</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский ортопед-травматолог</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский хирург</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский ЛОР</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский невролог</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский дерматолог</span></li>
        </ul>
        <ul class="section__content-ul col__50">
            <li class="section__content-li"><span class="section__content-link">Детский эндокринолог</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский рефлексотерапевт</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский мануальный терапевт</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский физиотерапевт</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский врач ЛФК</span></li>
            <li class="section__content-li"><span class="section__content-link">Детский гинеколог</span></li>
        </ul>
    </div>
    <div class="row">
    ...
    <div class="padding__row row">
        <h3 class="blue"><b>Запись по телефонам: +7 (777) 999-33-11  /  +7 (777) 999-33-11</b></h3>
    </div>
    <br>
    <br>
    <div class="row padding__row between hidden-xs">
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open1.jpg" class="rounded"></div>
        </div>
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open2.jpg" class="rounded"></div>
        </div>
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open3.jpg" class="rounded"></div>
        </div>
    </div>
    <div class="row padding__row between hidden-xs">
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open4.jpg" class="rounded"></div>
        </div>
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open5.jpg" class="rounded"></div>
        </div>
        <div class="col__32">
            <div class="img-wrapper"><img src="/images/test/open6.jpg" class="rounded"></div>
        </div>
    </div>
