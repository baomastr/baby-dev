$(document).ready(function() {
    ...
    $('.formAjax').submit(function(event) {
        ...
        /* отправляем данные методом POST */
        var posting = $.post( url, { h1: h1_form,  h2: h2_form, url: link, ajax: ajax, name: name, phone: phone, usr_name: usr_name, usr_email: usr_email, comment: comment, rating: rating, diapazon: diapazon } );
